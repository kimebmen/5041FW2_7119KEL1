...
<head>
  ...
  <title>@yield('page_title','Login/Register') | Pegadaian FKTI</title>
      ...
      <body>
        <section class="section-padding banner-wrapper login-alt banner-6 fullscreen-banner">
          <div class="container">
            ...
            <div class="card-wrapper"><center><a href="{{ url('landing')}}" class="waves-effect waves-light btn">HOME</a></center></div>
