...
<head>
	...
	<title>@yield('page_title','Halaman Awal Admin') | Pegadaian</title>
	<!-- Bootstrap Core CSS -->
...
<body id="page-top">
		...
		<div class="container">
			<div class="navbar-header">
				...
				<a id="hoax" class="navbar-brand page-scroll" href="{{url('home')}}"><img src="{{asset('pic/logo.png')}}" alt="logolayana"></a>
			</div>
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right">
					
					<li class="dropdown active">
						<a class="page-scroll" href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Operator <span class="caret"></span></a>
						<ul class="dropdown-menu" aria-labelledby="dLabel">
							<li><a href="{{url('operator')}}">Data Operator</a></li>							
						</ul>
					</li>
					<li class="dropdown active">
						<a class="page-scroll" href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Kategori Barang<span class="caret"></span></a>
						<ul class="dropdown-menu" aria-labelledby="dLabel">
							<li><a href="{{url('kategori_barang')}}">Kategori Barang</a></li>						
						</ul>
					</li>

					<li class="dropdown active">
						<a class="page-scroll" href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Kelas Pelayanan <span class="caret"></span></a>
						<ul class="dropdown-menu" aria-labelledby="dLabel">
							<li><a href="{{ url('kelas_pelayanan') }}">Kelas Pelayanan</a></li>				
						</ul>
...
-->
			...
			<section class="bg-dark turun" style="height: 200px; padding-top: 50px">
				<div class="container">
					<div class="row">
